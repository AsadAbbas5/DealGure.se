  ...
  return (
    <div className="ml-3">
      <div className="w-full min-h-[250px] mt-6 bg-white rounded-xl shadow-lg shadow-gray-200 p-4 gap-3 flex flex-col">
        ...
        <div>
          <p
            className="mt-1 text-base leading-6 font-normal font-nunito"
            style={{
          ...
          <p
            className="text-base leading-6 font-normal font-nunito"
            style={{
              fontSize: "15px !important",
              lineHeight: "1.5!important",
              background: "none !important",
          ...
          <br />
          <h2 className="text-lg font-semibold font-nunito">Safety in focus</h2>
          <p
            className="text-base leading-6 font-normal font-nunito"
            style={{
              fontSize: "15px !important",
          ...
          <br />
          <h2 className="text-lg font-semibold font-nunito">Stylish design</h2>
          <br />
          <p
            className="text-base leading-6 font-normal font-nunito"
            style={{
